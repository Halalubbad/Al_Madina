...
@section('page-md-title', __('almadina.tags'))
                                ...
                                <tbody>
                                    ...
                                    @foreach ($tags as $tag)
                                        <tr>
                                            ...
                                            <td>{{ $i }}</td>
                                            <td>{{ $tag->name }}</td>
                                            {{-- <td> @if ($tag->parent_id == 0) Parent Tag @else  @endif </td> --}}
                                            <td>{{ $tag->parent_id }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="#" onclick="confirmDelete('{{ $tag->id }}', this)"
...
@section('scripts')
    ...
    <script>
        ...
        function performDelete(id, reference) {
            axios.delete('/almadina/admin/tags/' + id)
